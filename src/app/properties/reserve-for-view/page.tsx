...
export default function ReserveForView() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10">
      <h1 className="font-heading lg:text-3xl md:text-2xl text-xl font-bold text-primary-600 sm:mb-6 mb-4">{tCommon('reserveForViewing')}</h1>

      {/* Customer & Property Details */}
      <section className="bg-white rounded-xl md:p-8 p-4 border border-black/10 sm:mb-6 mb-4 grid sm:grid-cols-2 grid-cols-1 gap-6">
        <div>
      ...
      {/* Amount Section */}
      <section className="bg-white rounded-xl md:p-8 p-4 border border-black/10 space-y-4 sm:mb-6 mb-4">
