  ...
  return (
    <div className="min-h-screen bg-white text-black p-8 print:p-0">
      ...
      <div className="print-container mx-auto max-w-4xl">
        ...
        <div className="flex items-stretch justify-between mb-6">
          <div className="flex items-center gap-3 w-1/3 border-r-4 border-secondary-600">
            <div className="relative">
              <svg width="225" height="60" viewBox="0 0 1220 328" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="text-sm text-neutral-500 w-2/3 pl-10">
            <h2 className='text-5xl font-normal font-yellowtail text-primary-600 mb-6 text-center'>You're in Safe Hands</h2>
            <div className='flex justify-between w-full'>
              <div className="text-sm text-neutral-600">
                <h4 className='text-3xl font-bold font-heading text-primary-600 mb-1'>Molina Office</h4>
                <div className='text-lg font-medium mb-2 text-primary-600'>info@inlandandalucia.com</div>
                <div className='text-lg font-medium text-primary-600'>www.inlandandalucia.com</div>
              </div>
              <div>
                ...
                <h4 className='text-lg font-semibold text-primary-600 mt-2 tracking-[.39rem]'>+34 952 741 525</h4>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Title */}
        <h1 className="text-3xl font-bold mb-3">{property.ref} - {property.type}</h1>
        <div className="grid grid-cols-3 items-baseline mb-1">
          <p>Ref: <strong className='text-2xl'>{property.ref}</strong></p>
          <p className="text-center"><strong>Town House</strong></p>
          <p className="mb-1 text-right">Price / Precio: <strong className='text-2xl'>{formatPrice(property.price.current)}</strong></p>
        </div>
