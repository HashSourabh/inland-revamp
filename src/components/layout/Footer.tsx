    ...
    <footer className="bg-primary-600 text-white">
      <div className="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          {/* Company Information */}
          <div>
            <h3 className="mb-4 text-xl font-bold">Inland Andalucia</h3>
            <p className="mb-6 text-primary-100/90">
              Specialists in inland properties across Andalucia, Spain. Offering personalized service to buyers and sellers since 2001.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="ml-3 text-primary-100/90">
              ...
              <li className="flex items-start">
                ...
                <span className="ml-3 text-primary-100/90">+34 952 741 525</span>
              </li>
              <li className="flex items-start">
                <EnvelopeIcon className="mt-1 h-5 w-5 flex-shrink-0 text-primary-300" />
                <span className="ml-3 text-primary-100/90">info@inlandandalucia.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="mb-4 text-primary-100/90">
        ...
        <div className="mt-12 border-t border-primary-800 pt-8">
          <div className="flex flex-col md:flex-row md:justify-between">
            <p className="text-sm text-primary-100/70">
              © {new Date().getFullYear()} Inland Andalucia. All rights reservedv.
            </p>
            <p className="mt-4 text-sm text-primary-100/70 md:mt-0">
              Designed & Developed by{" "}
              <a
                href="https://www.hashsoftware.com"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="mt-4 flex space-x-6 md:mt-0">
              ...
              {/* <Link href="/cookies" className="text-sm text-primary-100/70 hover:text-white transition-colors">
                Cookies
              </Link> */}
            </div>
          </div>
